...
- Historificación final: `MEKYTL1300` (`RAMERC0068.sh`), traslado a
  `backup/ExtraccionDUCOMASTERDATA_YYYYMMDD.csv`, con purga de ficheros de más de 6 meses.
...
Todos los gaps detectados quedaron resueltos con evidencia de Control-M en vivo, fichas
oficiales del gestor documental y lectura del código fuente de `RAMERC0068.sh`.
