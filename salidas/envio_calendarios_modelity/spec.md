...
- **Fallback ante viernes festivo (CSCF/TFIT):** se envía igual, sin posponer ni adelantar; se asume que se reflejará en el próximo día lectivo del sistema destino (asunción de negocio confirmada por el usuario, no verificada contra los sistemas destino — ver riesgos).
