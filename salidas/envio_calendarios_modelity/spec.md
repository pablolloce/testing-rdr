...
- **Criticidad W frente a impacto downstream (P-001/P-028/P-061):** confirmada tal cual en las fichas; el posible desajuste de riesgo queda pendiente de validación directa con los responsables de negocio — **riesgo abierto, no bloquea el cierre de esta especificación de testing**.
