...
- Las capturas v2 de Control-M para Productos incluyen Estadísticas con ejecución diaria desde al menos 20/08/2026 y vista Planning de MEKYTL1030 (activo desde 06/06/2020, creador algocmd). Los jobs ya ejecutan con éxito, por lo que la obtención de capturas de salida con parámetros .idx parseados debería ser viable. El patrón inconsistente del evento de MEKYTL1030 (`_new_MEKYTL1030_OK`) queda confirmado también por la vista Planning (pestaña Acciones).
- Las capturas v3 completan las vistas Planning de MEKYTL0404 y MEKYTL0405: los 3 jobs de envío comparten configuración de definición idéntica (creador algocmd, activo desde 06/06/2020, LMXJV, retención 3 días, 0 relanzamientos, prioridad Custom, no críticos). **Lección de intake:** tres entregas sucesivas tituladas "Contenido de ficheros .idx" no contenían ningún .idx — solo configuración de Control-M. Cuando un GAP pide el contenido de un fichero de configuración, conviene especificar explícitamente la vía de obtención (para .idx de MEGENV0001.sh: pestaña **Salida** de una ejecución completada, que muestra los parámetros parseados) en lugar de pedir "el contenido del fichero".
