...
- La sincronización a `nfq` es siempre por ruta explícita (`salidas/` y `memoria/`), nunca un merge de la rama personal completa; así `documentos_fuente/` queda excluido aunque esté commiteado en la rama personal.
