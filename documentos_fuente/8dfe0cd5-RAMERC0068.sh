...
MM=`date +%m`
AAAA=`date +%Y`
AAAAMMDD_1=`date --date='1 days ago' +%Y%m%d`
AAAAMMDD_SER=`date --date='2 days ago' +%Y%m%d`
AAAAMMDD_3=`date --date='3 days ago' +%Y%m%d`
...
MENOS_1MES_AAAAMM=`date +%Y%m --date='-1 month'`
AAAAMM=`date +%Y%m`
FECHA_BCP="#BCP-DATE#"
AAAAMMDD_3=`date --date='3 days ago' +%Y%m%d`
ANT_AAAAMMDD=`date --date='1 days ago' +%Y%m%d`
ANT_DD_MM_AAAA=`date --date='1 days ago' +%d-%m-%Y`
ANT_AAAA_MM_DD=`date --date='1 days ago' +%Y-%m-%d`
ANT_DDMMAAAA=`date --date='1 days ago' +%d%m%Y`
ANT_MMDDAA=`date --date='1 days ago' +%m%d%y`
ANT_MMDDAA_D2=`date --date='2 days ago' +%m%d%y`
ANT_MMDDAA_D4=`date --date='4 days ago' +%m%d%y`
ANT_DDMM=`date --date='1 days ago' +%d%m`
MMDDAA=`date +%m%d%y`
