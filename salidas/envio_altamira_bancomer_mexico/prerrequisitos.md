...
- **Riesgo abierto a resolver antes de operar con garantías en producción**: confirmar con el equipo de negocio el motivo de la exclusión de los 5 códigos hardcodeados, y confirmar contra logs reales de ejecución el mecanismo exacto de conversión de formato de fecha en el comando `datax-agent`.
